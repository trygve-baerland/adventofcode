...
{
    public IEnumerable<(TrenchWall naive, TrenchWall hex)> TestWalls() => "inputdata/day18_test.txt".GetLines().Select( line => Helpers.TrenchWallParser.Parse( line ) );
    public IEnumerable<(TrenchWall naive, TrenchWall hex)> ActualWalls() => "inputdata/day18.txt".GetLines().Select( line => Helpers.TrenchWallParser.Parse( line ) );
    public void Part1()
    {
