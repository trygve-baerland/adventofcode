...
{
    public GalaxyMap TestData = new GalaxyMap( "inputdata/day11_test.txt".GetLines().Select( l => l.ToCharArray() ).ToArray() );
    public GalaxyMap ActualData = new GalaxyMap( "inputdata/day11.txt".GetLines().Select( l => l.ToCharArray() ).ToArray() );
