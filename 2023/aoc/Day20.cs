...
{
    public ModuleResolver TestModule() => Helpers.ModuleResolverParser.Parse( string.Concat( "inputdata/day20_test.txt".Stream().GetChars() ) );
    public ModuleResolver ActualModule() => Helpers.ModuleResolverParser.Parse( string.Concat( "inputdata/day20.txt".Stream().GetChars() ) );
    public void Part1()
    {
