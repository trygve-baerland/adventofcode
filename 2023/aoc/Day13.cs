...
{
    public List<MirrorPattern> TestPatterns { get; } = Helpers.MirrorPatterns.Parse( string.Concat( "inputdata/day13_test.txt".Stream().GetChars() ) ).ToList();
    public List<MirrorPattern> ActualPatterns { get; } = Helpers.MirrorPatterns.Parse( string.Concat( "inputdata/day13.txt".Stream().GetChars() ) ).ToList();
    public void Part1()
    {
