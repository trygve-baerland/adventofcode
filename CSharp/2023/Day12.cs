...
{
    public List<SpringRecord> TestRecords { get; } = "2023/inputdata/day12_test.txt".Stream().GetLines().Select( SpringRecord.FromString ).ToList();
    public List<SpringRecord> ActualRecords { get; } = "2023/inputdata/day12.txt".Stream().GetLines().Select( SpringRecord.FromString ).ToList();
