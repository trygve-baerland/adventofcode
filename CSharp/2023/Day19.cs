...
{
    public (IRule rule, IEnumerable<MachinePart> parts) TestInput() => Helpers.ParseInput( "2023/inputdata/day19_test.txt" );
    public (IRule rule, IEnumerable<MachinePart> parts) ActualInput() => Helpers.ParseInput( "2023/inputdata/day19.txt" );
